...
import { DateValid, formatDate, validMinAge } from '../../utils/validaDateNasc'
      ...
      try {
        ...
        const schema = Yup.object().shape({
          ...
          dataNasc: Yup.string()
            ...
            .test('DateNasci', 'Idade Inferior a 12 anos', (date): any =>
              validMinAge(date)
            )
            .test('DateNasci', 'Data Invalida', (date): any => DateValid(date)),
          cpf: Yup.string()
            .min(14)
            .max(14)
            .test('cpf-valido', 'CPF Inválido', (cpf): any => validarCpf(cpf)),
          cep: Yup.string(),
          endereco: Yup.string(),
          numero: Yup.string(),
          ...
          <div className="modal-body">
            ...
            <div className="grid-container">
              ...
              <div className="modalGridNumber">
                <Input name="numero" icon={FiMap} placeholder="Número" />
              </div>
              <div>
                <Input
                  name="password"
